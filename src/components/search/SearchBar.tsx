...
export function SearchBar({ variant = 'default', className = '' }: SearchBarProps) {
  ...
  const inputClasses =
    variant === 'large'
      ? 'w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 px-5 py-4 pl-12 text-lg shadow-sm dark:text-gray-100 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:placeholder-gray-500'
      : 'w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 px-4 py-2 pl-10 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:text-gray-100 dark:placeholder-gray-500'
